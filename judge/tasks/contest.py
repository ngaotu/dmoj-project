...
from judge.models import Contest, ContestMoss, ContestParticipation, Submission, ContestSubmission, Problem
...
def prepare_contest_data(self, contest_id, options):
    ...
    with Progress(self, length, stage=_('Preparing contest data')) as p:
        ...
        exported = set()
        for user_id, username, problem, source, ext, sub_id in submissions:
