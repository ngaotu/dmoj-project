...
SITE_ID = 1
SITE_NAME = 'VJUOJ'
SITE_LONG_NAME = 'VJUOJ: VJU Online Judge'
SITE_ADMIN_EMAIL = ''
...
DMOJ_PROBLEM_DATA_ROOT = "/home/tung/Workspace/vjuoj/problems"
PROBLEM_STORAGE_ROOT = "/home/tung/Workspace/vjuoj/problems"
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ngaotu662003@gmail.com'  # Thêm địa chỉ Gmail của bạn vào đây
EMAIL_HOST_PASSWORD = 'ilwe fivc sekn ibxw'  # Thêm mật khẩu ứng dụng Gmail vào đây
DEFAULT_FROM_EMAIL = 'ngaotu662003@gmail.com'  # Thêm địa chỉ Gmail của bạn vào đây

# Registration settings
REGISTRATION_OPEN = True  # Cho phép đăng ký
SEND_ACTIVATION_EMAIL = True  # Gửi email xác nhận
