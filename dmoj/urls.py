...
from judge.views import TitledTemplateView, api, blog, comment, contests, language, license, mailgun, organization, \
    ...
    two_factor, user, widgets, welcome_page
...
urlpatterns = [
    # path('news', news.News.as_view(), name='home'),
    path('', welcome_page.WelcomePage.as_view(), name='home'),
    path('welcome', welcome_page.WelcomePage.as_view(), name='welcome'),
    path('home/', blog.PostList.as_view(template_name='blog/list.html', title=_('Home')), kwargs={'page': 1}, name='home'),
    path('500/', exception),
    ...
    path('check/', submission.SubmissionCheck, name = 'check_plagiarism'),
    ...
    path('import_users', include([
        ...
        # path('/import_users_to_contest/', user.import_users_to_contest, name='import_users_to_contest'),
    ])),

    # path('import_users_to_contest', include([
    #     path('/', user.ImportUsersView.as_view(), name='import_users'),
    #     path('/post_file/', user.import_users_post_file, name='import_users_post_file'),
    #     path('/import_users_to_contest/', user.import_users_to_contest, name='import_users_to_contest'),
    #     path('/sample/', user.sample_import_users, name='import_users_sample')
    ...
    path('about/', TitledTemplateView.as_view(template_name='about.html', title=_('About'))),
    ...
    # path('check/', paged_list_view(submission.))
